        ...
        <div className="lg:col-span-8 space-y-5 md:space-y-6">
          ...
          <div className="bg-zinc-900/40 rounded-[32px] md:rounded-[40px] p-6 md:p-8 border border-white/5 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 md:gap-5">
              ...
              >
                <svg className="w-5 h-5 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" strokeWidth={2.5} /></svg>
                <span className="hidden md:inline truncate">Download</span>
              </button>
            </div>
          </div>
